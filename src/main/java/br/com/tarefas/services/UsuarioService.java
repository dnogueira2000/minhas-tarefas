...
public class UsuarioService {
	...
	public Set<Role> getRoles(Usuario usuario) {
	...
	public JwtResponse autenticaUsuario(String nome, String senha) {
		...
		List<String> roles = userDetailsImple.getAuthorities().stream()
				.map(item -> item.getAuthority())
				.collect(Collectors.toList());
		
		return new JwtResponse(jwt, userDetailsImple.getId(), userDetailsImple.getUsername(), roles);
	}
